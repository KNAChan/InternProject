       ...
       FILE-CONTROL.
           SELECT CHECKINOUT-FILE ASSIGN TO '../CHECKINOUT'
           ...
           SELECT CUSTOMER-FILE ASSIGN TO '../CUSTOMERS'
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS CUSTOMER-ID.
           SELECT STAYLOG-FILE ASSIGN TO '../STAYLOG'
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS STAYLOG-ID.
           SELECT INVOICES-FILE ASSIGN TO '../INVOICES'
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
